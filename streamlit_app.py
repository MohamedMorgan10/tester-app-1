...
From: Mohamed Alsayed Morgan <maimorgan@americana-food.com>
Sent: Saturday, September 5, 2026 10:35 PM
To: Mohamed Alsayed Morgan <maimorgan@americana-food.com>
Subject: 
...
with tab8:
    ...
    if st.button("🚀 Start Live Video Simulation", use_container_width=True):
        ...
        for frame in range(total_frames + 1):
            ...
            # --- THE FIX IS APPLIED TO THIS LINE ---
            map_placeholder.plotly_chart(fig_live, use_container_width=True, key=f"live_map_{frame}")
...
________________________________________
From: Mohamed Alsayed Morgan <maimorgan@americana-food.com>
Sent: Saturday, September 5, 2026 10:30 PM
To: Mohamed Alsayed Morgan <maimorgan@americana-food.com>
Subject: 
 
To share this script as a text document, copy the code below and paste it into a plain text editor (such as Notepad on Windows or TextEdit on Mac), then save the file as streamlit_app.py or dashboard_script.txt. 
```text
import streamlit as st
import pandas as pd
import numpy as np
